...
#include "displayEditor/DisplayEditor.h"


class TestDisplayEditor : public QObject {
    Q_OBJECT
...
void TestDisplayEditor::test_defaultState() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_addElement() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_removeElement() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_updateElement() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_clearElements() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_displaySettings() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_validateConfig() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_exportAsImage() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_exportAsImageWithElements() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_saveLoadJson() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_saveLoadIni() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_saveLoadLua() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_animationConfig() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_physicsValues() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_exportImageProgressRing() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_exportImageAnimatedText() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_multipleElements() {
    ksDisplayEditor editor;
...
void TestDisplayEditor::test_getElementById() {
    ksDisplayEditor editor;
...
QTEST_MAIN(TestDisplayEditor)
#include "test_DisplayEditor.moc"
