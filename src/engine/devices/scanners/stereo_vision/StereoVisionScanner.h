...
public:
    ...
    Q_INVOKABLE ScanResult result() const { return m_result; }
    
    // Get captured pairs
    Q_INVOKABLE QList<CapturedPair> pairs() const { return m_pairs; }
    
    // Set parameters
    Q_INVOKABLE void setBaseline(qreal b) { m_baseline = b; }
    Q_INVOKABLE void setFocalLength(qreal f) { m_focalLength = f; }
...
private:
    ...
    // Finalize reconstruction after all pairs are captured
