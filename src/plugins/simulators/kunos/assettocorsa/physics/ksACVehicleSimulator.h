...
class class ksACVehicleSimulator : public IVehicleSimulator {
    Q_OBJECT
public:
    explicit explicit ksACVehicleSimulator(QObject* parent = nullptr);
    ~~ksACVehicleSimulator() override = default;
