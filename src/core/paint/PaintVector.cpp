...
void PaintVectorDocument::applyLpe(int idx){ auto &o=m_objects[idx]; if(o.lpe==VectorPathEffect::Simplify) simplify(idx, o.lpeParams.value("threshold",2.0).toDouble()); else if(o.lpe==VectorPathEffect::Inset) inset(idx, o.lpeParams.value("distance",5).toDouble()); else if(o.lpe==VectorPathEffect::Outset) outset(idx, o.lpeParams.value("distance",5).toDouble()); }
