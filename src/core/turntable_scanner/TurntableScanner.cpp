...
QString TurntableScanner::exportForPhotogrammetry(const QString& directory) const
{
    QString result;
    QDir dir(directory);
    if (!dir.mkpath(".")) {
...
void TurntableScanner::captureFromViewportAtPose(const TurntablePose& pose)
{
    ...
    // Trigger render and read back image
    ...
    if (QO) {
        ...
        QTimer::singleShot(100, this, [this, pose]() {
            ...
            // Note: This is simplified - actual implementation depends on Vulkan framebuffer read
