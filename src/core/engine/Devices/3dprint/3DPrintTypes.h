...
Q_DECLARE_METATYPE(ks::device::SliceSettings)
Q_DECLARE_METATYPE(ks::device::PrinterProfileData)
Q_DECLARE_METATYPE(ks::device::SliceInfo)
Q_DECLARE_METATYPE(ks::device::PrintPreviewFrame)
Q_DECLARE_METATYPE(ks::device::PrintSimulationState)
Q_DECLARE_METATYPE(ks::device::QualityProfile)
Q_DECLARE_METATYPE(ks::device::InfillPattern)
Q_DECLARE_METATYPE(ks::device::SupportType)
Q_DECLARE_METATYPE(ks::device::BedAdhesionType)
Q_DECLARE_METATYPE(ks::device::GCodeFlavor)