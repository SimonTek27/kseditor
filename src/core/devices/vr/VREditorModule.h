...
#if __has_include("core/devices/vr/XrManager.h")
#include "core/devices/vr/XrManager.h"
...
#define HAS_XR 0
#endif
#if __has_include("core/devices/vr/XrViewportRenderer.h")
#include "core/devices/vr/XrViewportRenderer.h"
#endif
#if __has_include("core/devices/vr/XrInput.h")
#include "core/devices/vr/XrInput.h"
#endif
...
class VREditorModule : public EditorModule {
    Q_OBJECT
public:
    explicit VREditorModule(QWidget* parent = nullptr) : EditorModule(parent) {}
    ~VREditorModule() override = default;
    ...
    QString getModuleIcon() const override { return QString(); }
    int getModulePriority() const override { return 50; }
    bool isVRModeActive() const { return false; }
protected:
    void onActivation() override {}
    void onDeactivation() override {}
};
