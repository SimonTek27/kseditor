...
public:
    ...
    // Clear all captures
    Q_INVOKABLE void clearCaptures();
    ...
    Q_INVOKABLE void setFocalLength(qreal fl) { m_focalLength = fl; }
    Q_INVOKABLE void setSensorWidth(qreal sw) { m_sensorWidth = sw; }
    Q_INVOKABLE void setImageSize(qreal w, qreal h) { m_imageWidth = w; m_imageHeight = h; }
