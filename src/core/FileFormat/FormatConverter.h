...
public:
    ...
    bool convertToMeshData(const QString& inputPath, fileformat::MeshData& outData,
                           QString* error = nullptr);
    bool convertFromMeshData(const fileformat::MeshData& data, const QString& outputPath,
                             QString* error = nullptr);
...
private:
    ...
    bool modelToKN5(const fileformat::MeshData& model, const QString& outputPath);
    bool modelToOBJ(const fileformat::MeshData& model, const QString& outputPath);
    bool modelToFBX(const fileformat::MeshData& model, const QString& outputPath);
    bool modelToGLTF(const fileformat::MeshData& model, const QString& outputPath);
    bool kn5ToModel(const QString& inputPath, fileformat::MeshData& model);
};
