...
public:
    ...
    QStringList layerTypes() const { return graphics::PaintSystem::getLayerTypes(); }
    QStringList supportedCountries() const { return graphics::PaintSystem::getSupportedCountries(); }
...
private:
    ...
    graphics::PaintManager* m_manager = nullptr;
};
