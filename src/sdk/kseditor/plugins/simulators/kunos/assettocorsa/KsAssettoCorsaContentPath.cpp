...
QString KsACPaths::getContentDirectory(const QString& ksRoot) {
    return ksRoot + "/content";
}

QString KsACPaths::getCarsDirectory(const QString& ksRoot) {
    return ksRoot + "/content/cars";
}

QString KsACPaths::getTracksDirectory(const QString& ksRoot) {
    return ksRoot + "/content/tracks";
}

QString KsACPaths::getSkinsDirectory(const QString& carPath) {
    return carPath + "/skins";
}

QString KsACPaths::getCarSkinDirectory(const QString& carPath, const QString& skinName) {
    return carPath + "/skins/" + skinName;
}

QString KsACPaths::getDriverDirectory(const QString& ksRoot) {
    return ksRoot + "/content/driver";
}

QString KsACPaths::getSfxDirectory(const QString& ksRoot) {
    return ksRoot + "/content/sfx";
}

QString KsACPaths::getTexturesDirectory(const QString& ksRoot) {
    return ksRoot + "/content/textures";
}

QString KsACPaths::getFontsDirectory(const QString& ksRoot) {
    return ksRoot + "/content/fonts";
}

QString KsACPaths::getShowroomDirectory(const QString& ksRoot) {
    return ksRoot + "/content/showroom";
}

QString KsACPaths::getWeatherDirectory(const QString& ksRoot) {
    return ksRoot + "/content/weather";
}

QString KsACPaths::getTracksWeatherDirectory(const QString& trackPath) {
    return trackPath + "/weather";
}

QStringList KsACPaths::getCarNames(const QString& ksRoot) {
...
QStringList KsACPaths::getTrackNames(const QString& ksRoot) {
...
QStringList KsACPaths::getSkinNames(const QString& carPath) {
...
QString KsACPaths::getMainCarFile(const QString& carPath) {
    QDir dir(carPath);
...
bool KsACPaths::isValidInstallation(const QString& path) {
...
QStringList KsACPaths::findAllInstallations() {
...
QStringList KsACPaths::getCarList(const QString& simPath) {
    return getCarNames(simPath);
}

QStringList KsACPaths::getTrackList(const QString& simPath) {
    return getTrackNames(simPath);
}

QString KsACPaths::findCarPath(const QString& simPath, const QString& carName) {
...
QString KsACPaths::findTrackPath(const QString& simPath, const QString& trackName) {
...
QString KsACPaths::getUiDirectory(const QString& simPath) {
    return simPath + "/system/ui";
}

QString KsACPaths::findBestInstallation() {
