...
class OfficeQmlBridge : public QObject {
    Q_OBJECT
...
public:
    static OfficeQmlBridge* instance();
...
private:
    explicit OfficeQmlBridge(QObject* parent = nullptr);
    static OfficeQmlBridge* s_instance;

    OfficeManager* m_manager = nullptr;
    OfficeServer* m_server = nullptr;
