...
namespace ks { namespace graphics { class Mesh3D; class Scene3D; class Material3D; } }
...
public:
    ...
    graphics::Mesh3D* importMesh(const QString& path);
    bool exportMesh(graphics::Mesh3D* mesh, const QString& path, Format format);

    graphics::Scene3D* importScene(const QString& path);
    bool exportScene(graphics::Scene3D* scene, const QString& path, Format format);
    ...
    struct ImportResult {
        bool success;
        QString error;
        graphics::Scene3D* scene = nullptr;
    };
...
private:
    bool importOBJ(const QString& path, graphics::Scene3D* scene);
    bool importGLTF(const QString& path, graphics::Scene3D* scene);
    bool importSTL(const QString& path, graphics::Scene3D* scene);
    bool importFBX(const QString& path, graphics::Scene3D* scene);
    bool importKS3D(const QString& path, graphics::Scene3D* scene);
    bool import3DM(const QString& path, graphics::Scene3D* scene);
    bool export3DM(graphics::Scene3D* scene, const QString& path);


    bool exportOBJ(graphics::Scene3D* scene, const QString& path);
    bool exportGLTF(graphics::Scene3D* scene, const QString& path);
    bool exportSTL(graphics::Scene3D* scene, const QString& path);
    bool exportKS3D(graphics::Scene3D* scene, const QString& path);
