...
// ─── License Plate Texture Generator for 22 Countries ─────────────────────────
...
Q_DECLARE_METATYPE(ks::graphics::LicensePlate)
Q_DECLARE_METATYPE(ks::graphics::CountryCode)
Q_DECLARE_METATYPE(ks::graphics::BatchGenerationOptions)