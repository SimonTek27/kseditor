 ...
 * - Camera positioning
 * - Lighting setup (directional, point, spot, area, IES, HDRI)
 ...
 * - physically-based rendering with SSLR, SSAO, PCSS effects
 */
...
public:
    ...
    static bool generateCustomPreview(const QString& carPath, const PreviewConfig& config,
