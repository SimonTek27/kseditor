...
Rectangle {
    ...
    Shortcut { sequence: "Ctrl+O"; onActivated: openDialog.open(); description: "Load Config" }
    Shortcut { sequence: "Ctrl+S"; onActivated: { if (ShowroomEditor.showroomName) ShowroomEditor.saveShowroom(""); else saveDialog.open() }; description: "Save Config" }
