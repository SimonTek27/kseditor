                ...
                ScrollView {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Slider { from: 10; to: 200; value: lodDistance; Layout.fillWidth: true; height: 18 }
                        ...
                        RowLayout {
                            Layout.leftMargin: 8; Layout.rightMargin: 8
                            CheckBox { checked: true; height: 16 }
                        ...
                        RowLayout {
                            ...
                            TextField { Layout.fillWidth: true; height: 20; font.pixelSize: 9; placeholderText: "Simulator path"; color: "#ccc" }
                        }
                        ...
                        RowLayout {
                            Layout.leftMargin: 8; Layout.rightMargin: 8
                            CheckBox { checked: true; height: 16 }
                            Text { text: "Reduce LODs"; color: "#888"; font.pixelSize: 9 }
                        }
