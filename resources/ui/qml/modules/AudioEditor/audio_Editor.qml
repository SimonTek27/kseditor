    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                KsButton { text: "Import"; flat: true; height: 32; bgcolor: "transparent"; color: "#ffffff"; onClicked: audioImportDialog.open() }
                KsButton { text: "Export"; flat: true; height: 32; bgcolor: "transparent"; color: "#ffffff"; onClicked: audioExportDialog.open() }
                ...
                KsButton { text: "Stop"; flat: true; height: 32; bgcolor: "transparent"; color: "#ffffff"
                ...
                ColumnLayout {
                    ...
                    Loader {
                        ...
                        sourceComponent: ColumnLayout {
                            ...
                            RowLayout {
                                KsButton { height: 28; text: "Play"; bgcolor: cAccent; color: "#121212"
                                    onClicked: { if (AudioBridge) AudioBridge.play() } }
                                KsButton { height: 28; text: "Stop"; bgcolor: "transparent"; color: "#ffffff"
                                    onClicked: { if (AudioBridge) AudioBridge.stop() } }
                                KsButton { height: 28; text: "Loop"; bgcolor: AudioBridge && AudioBridge.isLoopEnabled ? cAccent : "transparent"; color: "#ffffff"
                                    onClicked: { if (AudioBridge) AudioBridge.isLoopEnabled = !AudioBridge.isLoopEnabled } }
                            }
                        }
                    }
                    ...
                    Loader {
                        ...
                        sourceComponent: ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                KsButton { height: 36; text: "Compressor"; bgcolor: cAccent; color: "#121212"; onClicked: { if (AudioBridge) AudioBridge.applyCompressor(-20, 4, 5, 100, 0) } }
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            KsButton { height: 22; text: "Browse..."; bgcolor: "transparent"; color: "#ffffff"; font.pixelSize: 8
