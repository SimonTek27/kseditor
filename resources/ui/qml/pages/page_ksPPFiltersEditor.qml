    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                AppButton { height: 28; text: "Wipe"; bgcolor: "transparent"; color: "#ffffff"; onClicked: { if (PPFilters) PPFilters.startPreview() } }
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            spacing: 4
                            Text { text: "Parameters"; color: "#ffffff"; font.pixelSize: 11 }
                            Text { id: paramCountText; text: PPFilters ? PPFilters.filterCount + " filters loaded" : "No filters"; color: "#888888"; font.pixelSize: 10 }
                            Text { id: currentFilterText; text: PPFilters ? "Active: " + PPFilters.currentFilter : ""; color: "#888888"; font.pixelSize: 10; elide: Text.ElideRight }
                        }

                        Item { Layout.fillWidth: true }

                        AppButton { height: 36; text: "Reset"; bgcolor: "#E10600"; color: "#121212"; onClicked: { if (PPFilters) PPFilters.resetParameters() } }
