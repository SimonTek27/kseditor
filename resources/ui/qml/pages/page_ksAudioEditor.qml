...
Rectangle {
    ...
    ColumnLayout {
        ...
        Rectangle {
            height: 32; color: cPanel; Layout.fillWidth: true; border.color: cBorder; border.width: 1
            RowLayout {
                anchors.fill: parent; anchors.leftMargin: 6; anchors.rightMargin: 6; spacing: 2
                Repeater {
                    model: [{ label: "New", tip: "New (Ctrl+N)" },{ label: "Open", tip: "Open (Ctrl+O)" },{ label: "Save", tip: "Save (Ctrl+S)" },{ label: "SaveAs", tip: "Save As" }]
                    delegate: Rectangle {
                        width: 52; height: 26; radius: 3; color: tb1Ma.containsMouse ? "#3c3c3c" : "transparent"
                ...
                Repeater {
                    model: [{ label: "Undo", tip: "Undo (Ctrl+Z)" },{ label: "Redo", tip: "Redo (Ctrl+Y)" },{ label: "Cut", tip: "Cut (Ctrl+X)" },{ label: "Copy", tip: "Copy (Ctrl+C)" },{ label: "Paste", tip: "Paste (Ctrl+V)" },{ label: "Del", tip: "Delete (Del)" }]
                    delegate: Rectangle {
                        width: 46; height: 26; radius: 3; color: tb2Ma.containsMouse ? "#3c3c3c" : "transparent"
                        Text { anchors.centerIn: parent; text: modelData.label; color: "#ccc"; font.pixelSize: 10 }
                ...
                Rectangle { width: 1; height: 20; color: cBorder }
                Repeater {
                    model: [{ label: "Trim", tip: "Trim to selection" },{ label: "Crop", tip: "Crop selection" },{ label: "Sel All", tip: "Select All (Ctrl+A)" },{ label: "Sel End", tip: "Select to end" }]
                    delegate: Rectangle {
                        width: 50; height: 26; radius: 3; color: tb3Ma.containsMouse ? "#3c3c3c" : "transparent"
                        Text { anchors.centerIn: parent; text: modelData.label; color: "#ccc"; font.pixelSize: 10 }
                ...
                Rectangle { width: 1; height: 20; color: cBorder }
                Repeater {
                    model: [{ label: "Z+", tip: "Zoom In" },{ label: "Z-", tip: "Zoom Out" },{ label: "ZFit", tip: "Zoom to fit" },{ label: "ZSel", tip: "Zoom to selection" }]
                    delegate: Rectangle {
                        width: 42; height: 26; radius: 3; color: tb4Ma.containsMouse ? "#3c3c3c" : "transparent"
                        Text { anchors.centerIn: parent; text: modelData.label; color: "#ccc"; font.pixelSize: 10 }
        ...
        Rectangle {
            height: 30; color: "#2a2a2a"; Layout.fillWidth: true; border.color: cBorder; border.width: 1
            RowLayout {
                anchors.fill: parent; anchors.leftMargin: 6; spacing: 2
                Repeater {
                    model: [
                        { label: "Volume", tip: "Change Volume" },{ label: "Fade In", tip: "Fade In" },{ label: "Fade Out", tip: "Fade Out" },
                        { label: "Normalize", tip: "Normalize" },{ label: "Reverse", tip: "Reverse" },{ label: "Invert", tip: "Invert" },
                        { label: "Compressor", tip: "Compressor" },{ label: "EQ", tip: "Equalizer" },{ label: "Reverb", tip: "Reverb" },
                        { label: "Delay", tip: "Delay" },{ label: "Chorus", tip: "Chorus" },{ label: "Flanger", tip: "Flanger" },
                        { label: "Pitch", tip: "Pitch Shift" },{ label: "Time Str", tip: "Time Stretch" },{ label: "Noise Red", tip: "Noise Reduction" },
                        { label: "Gate", tip: "Noise Gate" },{ label: "Limiter", tip: "Limiter" },{ label: "Stereo", tip: "Stereo Enhancer" }
                    ]
                    delegate: Rectangle {
                        width: efMa.containsMouse ? 64 : 54; height: 24; radius: 3
                        color: efMa.containsMouse ? cAccent : "#3c3c3c"
                        Behavior on width { NumberAnimation { duration: 100 } }
                        Text { anchors.centerIn: parent; text: modelData.label; color: efMa.containsMouse ? "#111111" : "#aaa"; font.pixelSize: 9; font.bold: efMa.containsMouse }
                        MouseArea { id: efMa; anchors.fill: parent; hoverEnabled: true
                            onClicked: {
        ...
        RowLayout {
                            ...
                            Repeater {
                                ...
                                delegate: Column {
                                    ...
                                    Repeater {
                                        ...
                                        delegate: Rectangle {
                                            width: parent.width; height: 16; color: evMouse.containsMouse ? "#334" : (currentFileName.indexOf(modelData) >= 0 ? "#003355" : "transparent"); radius: 1
                                            Text { anchors.left: parent.left; anchors.leftMargin: 14; anchors.verticalCenter: parent.verticalCenter; text: modelData; color: currentFileName.indexOf(modelData) >= 0 ? cAccent : "#777"; font.pixelSize: 8 }
            ...
            Rectangle {
                Layout.fillWidth: true; Layout.fillHeight: true; color: cBg
                ColumnLayout {
                    anchors.fill: parent; anchors.margins: 2; spacing: 2
                    Rectangle {
                        Layout.fillWidth: true; height: 24; color: "#252526"
                        Row { anchors.fill: parent; anchors.leftMargin: 4; spacing: 2
                            Rectangle { width: tabLabel.contentWidth + 20; height: 22; radius: 3; color: "#333"
                    ...
                    Rectangle {
                        Layout.fillWidth: true; Layout.fillHeight: true; color: "#111111"; border.color: "#222"; border.width: 1
                        ColumnLayout { anchors.fill: parent; anchors.margins: 2; spacing: 0
                            ...
                            Rectangle { Layout.fillWidth: true; Layout.fillHeight: true; color: "#0a0a0a"
                                Canvas { id: waveCanvasL; anchors.fill: parent
                                    onPaint: {
                                        var ctx = getContext("2d"); ctx.clearRect(0, 0, width, height)
                                        if (!AudioBridge || AudioBridge.getSampleCount() === 0) {
                                            ctx.fillStyle = "#333"; ctx.font = "11px sans-serif"; ctx.textAlign = "center"
                                            ctx.fillText("No audio loaded", width/2, height/2); return
                                        }
                                        var data = AudioBridge.getWaveformData(Math.floor(width))
                                        if (data.length === 0) return
                                        var midY = height / 2
                                        ctx.strokeStyle = cWaveL; ctx.lineWidth = 1; ctx.beginPath()
                                        for (var i = 0; i < data.length; ++i) {
                                            var x = i; var sample = parseFloat(data[i]) * midY * 0.9
                                            ctx.moveTo(x, midY - sample); ctx.lineTo(x, midY + sample)
                                        }
                                        ctx.stroke()
                                        ctx.strokeStyle = "#222"; ctx.beginPath(); ctx.moveTo(0, midY); ctx.lineTo(width, midY); ctx.stroke()
                                    }
                                    Connections { target: AudioBridge; function onPositionChanged() { waveCanvasL.requestPaint() } }
                                }
                                Rectangle { x: playbackPosition / Math.max(0.01, totalDuration) * parent.width; width: 1; height: parent.height; color: "#ffffff"; opacity: 0.7; visible: isPlaying || playbackPosition > 0 }
                                Rectangle { x: selectionStart * parent.width; width: (selectionEnd - selectionStart) * parent.width; height: parent.height; color: cAccent; opacity: 0.15 }
                            }
                            Rectangle { Layout.fillWidth: true; height: 16; color: "transparent"
                            ...
                            Rectangle { Layout.fillWidth: true; Layout.fillHeight: true; color: "#0a0a0a"
                                Canvas { id: waveCanvasR; anchors.fill: parent
                                    onPaint: {
                                        var ctx = getContext("2d"); ctx.clearRect(0, 0, width, height)
                                        ...
                                        if (data.length === 0) return
                                        var midY = height / 2
                                        ctx.strokeStyle = cWaveR; ctx.lineWidth = 1; ctx.beginPath()
                                        for (var i = 0; i < data.length; ++i) {
                                            var x = i; var sample = parseFloat(data[i]) * midY * 0.9
                                            ctx.moveTo(x, midY - sample); ctx.lineTo(x, midY + sample)
                                        }
                        ...
                        Rectangle {
                            anchors.bottom: parent.bottom; anchors.left: parent.left; anchors.right: parent.right; height: 18; color: "#1a1a1a"
                            Canvas { id: timeAxisCanvas; anchors.fill: parent
                                onPaint: {
                                    var ctx = getContext("2d"); ctx.clearRect(0, 0, width, height); ctx.fillStyle = "#555"; ctx.font = "8px monospace"; ctx.textAlign = "center"
                                    var dur = totalDuration; if (dur <= 0) dur = 1; var step = dur / 10
                                    for (var i = 0; i <= 10; i++) {
                                        var x = i * width / 10; var t = i * step
                                        ctx.fillText(Math.floor(t / 60) + ":" + (Math.floor(t % 60) < 10 ? "0" : "") + Math.floor(t % 60), x, 12)
                                        ctx.strokeStyle = "#333"; ctx.beginPath(); ctx.moveTo(x, 0); ctx.lineTo(x, 6); ctx.stroke()
                                    }
                                }
                                Connections { target: root; function onTotalDurationChanged() { timeAxisCanvas.requestPaint() } }
                            }
                        }
                    }
                    Rectangle {
                        Layout.fillWidth: true; height: 30; color: "#1a1a1a"; border.color: "#222"; border.width: 1
                        Canvas { id: overviewCanvas; anchors.fill: parent
                            onPaint: {
                                ...
                                ctx.stroke()
                                ctx.fillStyle = "rgba(0,170,255,0.25)"; ctx.fillRect(selectionStart * width, 0, (selectionEnd - selectionStart) * width, height)
            ...
            Rectangle {
                width: 200; Layout.fillHeight: true; color: cPanel; border.color: cBorder; border.width: 1
                ColumnLayout { anchors.fill: parent; anchors.margins: 6; spacing: 6
                    ...
                    GridLayout { columns: 5; Layout.fillWidth: true; columnSpacing: 2; rowSpacing: 2
                        Rectangle { Layout.fillWidth: true; height: 32; radius: 4; color: ctrlRewindMa.containsMouse ? "#333" : "#2a2a2a"
                            ...
                            MouseArea { id: ctrlRewindMa; anchors.fill: parent; hoverEnabled: true; onClicked: { if (AudioBridge) AudioBridge.seek(Math.max(0, playbackPosition - 5)) } }
                        }
                        Rectangle { Layout.fillWidth: true; height: 32; radius: 4; color: ctrlPlayMa.containsMouse ? "#333" : (isPlaying ? cAccent : "#2a2a2a")
                            ...
                            MouseArea { id: ctrlPlayMa; anchors.fill: parent; hoverEnabled: true; onClicked: { if (AudioBridge) { if (isPlaying) AudioBridge.pause(); else AudioBridge.play() } } }
                        }
                        Rectangle { Layout.fillWidth: true; height: 32; radius: 4; color: ctrlStopMa.containsMouse ? "#333" : "#2a2a2a"
                            Text { anchors.centerIn: parent; text: "\u23F9"; color: "#ccc"; font.pixelSize: 16 }
                            MouseArea { id: ctrlStopMa; anchors.fill: parent; hoverEnabled: true; onClicked: { if (AudioBridge) AudioBridge.stop() } }
                        }
                        Rectangle { Layout.fillWidth: true; height: 32; radius: 4; color: ctrlFFMa.containsMouse ? "#333" : "#2a2a2a"
                            Text { anchors.centerIn: parent; text: "\u23E9"; color: "#ccc"; font.pixelSize: 16 }
                            MouseArea { id: ctrlFFMa; anchors.fill: parent; hoverEnabled: true; onClicked: { if (AudioBridge) AudioBridge.seek(Math.min(totalDuration, playbackPosition + 5)) } }
                        }
                        Rectangle { Layout.fillWidth: true; height: 32; radius: 4; color: ctrlLoopMa.containsMouse ? "#333" : (isLooping ? "#004466" : "#2a2a2a")
                            ...
                            MouseArea { id: ctrlLoopMa; anchors.fill: parent; hoverEnabled: true; onClicked: { if (AudioBridge) AudioBridge.setLoopEnabled(!AudioBridge.isLoopEnabled) } }
                        }
                    }
                    Rectangle { height: 1; color: cBorder; Layout.fillWidth: true }
                    RowLayout { Text { text: "Vol"; color: "#888"; font.pixelSize: 9; width: 28 }
                        Slider { id: volSlider; from: 0; to: 100; value: masterVolume; Layout.fillWidth: true; height: 16
                    ...
                    RowLayout { Text { text: "Spd"; color: "#888"; font.pixelSize: 9; width: 28 }
                        Slider { id: speedSlider; from: 0.25; to: 4.0; value: playbackSpeed; stepSize: 0.05; Layout.fillWidth: true; height: 16
                    ...
                    Rectangle { height: 1; color: cBorder; Layout.fillWidth: true }
                    Rectangle { height: 20; Layout.fillWidth: true; color: "transparent"; Text { text: "LEVELS"; color: "#666"; font.pixelSize: 9; font.bold: true } }
                    RowLayout { Text { text: "L"; color: cWaveL; font.pixelSize: 9; width: 12 }
                    ...
                    RowLayout { Text { text: "R"; color: cWaveR; font.pixelSize: 9; width: 12 }
                        Rectangle { Layout.fillWidth: true; height: 12; color: "#111"; radius: 2
                    ...
                    Rectangle { height: 1; color: cBorder; Layout.fillWidth: true }
                    Rectangle { height: 20; Layout.fillWidth: true; color: "transparent"; Text { text: "FILE INFO"; color: "#666"; font.pixelSize: 9; font.bold: true } }
                    Column { spacing: 2; Text { text: "File: " + currentFileName; color: "#777"; font.pixelSize: 8; elide: Text.ElideRight; width: 188 }
                    ...
                    RowLayout { Layout.fillWidth: true
                        Rectangle { Layout.fillWidth: true; height: 28; radius: 4; color: qaUndoMa.containsMouse ? "#333" : "#2a2a2a"
                            ...
                            MouseArea { id: qaUndoMa; anchors.fill: parent; hoverEnabled: true; onClicked: { if (AudioBridge) AudioBridge.undo() } }
                        }
                        Rectangle { Layout.fillWidth: true; height: 28; radius: 4; color: qaRedoMa.containsMouse ? "#333" : "#2a2a2a"
                            ...
                            MouseArea { id: qaRedoMa; anchors.fill: parent; hoverEnabled: true; onClicked: { if (AudioBridge) AudioBridge.redo() } }
                        }
                    }
                    Rectangle { Layout.fillWidth: true; height: 32; radius: 4; color: renderMa.containsMouse ? "#005577" : cAccent
                        ...
                        MouseArea { id: renderMa; anchors.fill: parent; hoverEnabled: true; onClicked: { if (AudioBridge) AudioBridge.saveAudio(currentFileName); statusMessage = "Saved" } }
                    }
                }
            }
        }
        ...
        Rectangle {
            height: 22; color: "#252526"; Layout.fillWidth: true; border.color: cBorder; border.width: 1
    ...
    Connections {
        ...
        function onPositionChanged() { waveCanvasL.requestPaint(); waveCanvasR.requestPaint(); overviewCanvas.requestPaint() }
    }
}
